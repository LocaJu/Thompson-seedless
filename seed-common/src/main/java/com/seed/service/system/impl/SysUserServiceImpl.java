package com.seed.service.system.impl;
...
import com.seed.domain.entity.system.SysRole;
import com.seed.domain.entity.system.SysUser;
import com.seed.domain.vo.UserInfoVo;
import com.seed.domain.vo.system.SysUserPost;
import com.seed.domain.vo.system.SysUserRole;
import com.seed.enums.AppHttpCodeEnum;
import com.seed.exception.ServiceException;
import com.seed.exception.SystemException;
import com.seed.mapper.system.SysPostMapper;
import com.seed.mapper.system.SysUserPostMapper;
import com.seed.mapper.system.SysUserRoleMapper;
import com.seed.mapper.system.SysUserMapper;
import com.seed.mapper.system.SysRoleMapper;
import com.seed.ruoyi.annotation.DataScope;
import com.seed.ruoyi.constant.UserConstants;
import com.seed.ruoyi.utils.StringUtils;
import com.seed.ruoyi.utils.bean.BeanValidators;
...
//        save(user);
    ...
    private boolean UserNameExist(UserRegiterDTO userRegiterDTO) {
        SysUser sysUser = userMapper.selectUserByUserName(userRegiterDTO.getUserName());
        return null!=sysUser;
    ...
    private boolean NickNameExist(UserRegiterDTO userRegiterDTO) {
        SysUser sysUser = userMapper.selectUserByNickName(userRegiterDTO.getNickName());
        return null!=sysUser;
    }
